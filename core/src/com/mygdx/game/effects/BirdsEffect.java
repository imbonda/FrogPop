...
public class BirdsEffect {
    ...
    private void postition(){
        ...
        if(speed1.y<0||speed2.y<0||speed3.y<0){
            ...
            if(speed1.x>0){faceSideBird1=true;}
            else if(speed1.x<0) {faceSideBird1=false;}
            if(speed2.x>0){faceSideBird2=true;}
            else if(speed2.x<0) {faceSideBird2=false;}
            if(speed2.x>0){faceSideBird3=true;}
            else if(speed3.x<0) {faceSideBird3=false;}
