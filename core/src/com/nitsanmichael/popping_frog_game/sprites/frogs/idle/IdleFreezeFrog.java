...
public class IdleFreezeFrog extends IdleFrog {
    ...
    public IdleFreezeFrog(com.nitsanmichael.popping_frog_game.assets.AssetController assetController, AnimationType type, Vector2 position) {
        this.animation = (AnimationType.NORMAL == type) ?
                (assetController.getAnimation(com.nitsanmichael.popping_frog_game.assets.Assets.FREEZE_FROG_ANIMATION, 0.15f)) :
                (assetController.getAnimation(com.nitsanmichael.popping_frog_game.assets.Assets.FREEZE_FROG_BIG_ANIMATION, 0.15f));
